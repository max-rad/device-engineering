...
var HeaderAccordion = /*#__PURE__*/function () {
  ...
  _createClass(HeaderAccordion, [{
    ...
    value: function _itemClickHandler(evt) {
      evt.preventDefault();
      var item = evt.target.closest('[data-header-accordion-item]');
    ...
    value: function _breakpointChecker() {
      var _this = this;
      var menuItems = document.querySelectorAll('[data-header-accordion-item]');
      if (!menuItems.length) {
        return;
      }
      if (this._breakpointMedia.matches) {
        menuItems.forEach(function (item) {
          var link = item.querySelector('[data-header-accordion-link]');
          link.addEventListener('click', _this._itemClickHandler);
        });
      } else {
        menuItems.forEach(function (item) {
          item.removeEventListener('click', _this._itemClickHandler);
          if (item.classList.contains('is-active')) {
            item.classList.remove('is-active');
          }
        });
