...
var initGallery = function initGallery() {
  ...
  document.addEventListener('click', function (evt) {
    ...
    evt.preventDefault();
    var src = target.closest('[data-gallery-src]').dataset.gallerySrc;
    image.src = src;
  });
};
...
/***/ "./js/modules/sliders/init-certificates-slider.js":
/*!********************************************************!*\
  !*** ./js/modules/sliders/init-certificates-slider.js ***!
  \********************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCertificatesSlider: function() { return /* binding */ initCertificatesSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="certificates"]');
...
/***/ "./js/modules/sliders/init-completed-projects-slider.js":
/*!**************************************************************!*\
  !*** ./js/modules/sliders/init-completed-projects-slider.js ***!
  \**************************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCompletedProjectsSlider: function() { return /* binding */ initCompletedProjectsSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="completed-projects"]');
var initCompletedProjectsSlider = function initCompletedProjectsSlider() {
  if (!slider) {
    return;
  }
...
/***/ "./js/modules/sliders/init-equipment-slider.js":
/*!*****************************************************!*\
  !*** ./js/modules/sliders/init-equipment-slider.js ***!
  \*****************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initEquipmentSlider: function() { return /* binding */ initEquipmentSlider; }
/* harmony export */ });
var slider = document.querySelector('[data-slider="equipment"]');
var initEquipmentSlider = function initEquipmentSlider() {
  if (!slider) {
    return;
  }
  var swiper = new Swiper(slider, {
...
/***/ "./js/modules/video-loader/init-video-loader.js":
/*!******************************************************!*\
  !*** ./js/modules/video-loader/init-video-loader.js ***!
  \******************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initVideoLoader: function() { return /* binding */ initVideoLoader; }
/* harmony export */ });
/* harmony import */ var _video_loader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./video-loader */ "./js/modules/video-loader/video-loader.js");

var initVideoLoader = function initVideoLoader() {
  var videoLoader = new _video_loader__WEBPACK_IMPORTED_MODULE_0__.VideoLoader();
  videoLoader.init();
};
...
/***/ "./js/modules/video-loader/video-loader.js":
/*!*************************************************!*\
  !*** ./js/modules/video-loader/video-loader.js ***!
  \*************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
  ...
  _createClass(VideoLoader, [{
    ...
    value: function init() {
      ...
      this._videos.forEach(function (video) {
        var preview = video.querySelector('[data-video-preview]');
        var loader = video.querySelector('[data-video-loader]');
        var iframe = video.querySelector('[data-video-iframe]');
        var videoSrc;
        if (video.dataset.video) {
          videoSrc = video.dataset.video;
        }
        _this._initYoutubePlayer(preview, loader, iframe, videoSrc);
      });
    }
  }, {
    key: "_initYoutubePlayer",
    value: function _initYoutubePlayer(preview, loader, iframe, videoSrc) {
...
/* harmony import */ var _modules_header_accordion_init_header_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/header-accordion/init-header-accordion */ "./js/modules/header-accordion/init-header-accordion.js");
/* harmony import */ var _modules_sliders_init_certificates_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/sliders/init-certificates-slider */ "./js/modules/sliders/init-certificates-slider.js");
/* harmony import */ var _modules_phone_mask__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/phone-mask */ "./js/modules/phone-mask.js");
...
/* harmony import */ var _modules_sliders_init_equipment_slider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/sliders/init-equipment-slider */ "./js/modules/sliders/init-equipment-slider.js");
/* harmony import */ var _modules_sliders_init_completed_projects_slider__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/sliders/init-completed-projects-slider */ "./js/modules/sliders/init-completed-projects-slider.js");
/* harmony import */ var _modules_modal_init_modals__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/modal/init-modals */ "./js/modules/modal/init-modals.js");
/* harmony import */ var _modules_init_gallery__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/init-gallery */ "./js/modules/init-gallery.js");
/* harmony import */ var _modules_video_loader_init_video_loader__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/video-loader/init-video-loader */ "./js/modules/video-loader/init-video-loader.js");
...
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    ...
    (0,_modules_header_accordion_init_header_accordion__WEBPACK_IMPORTED_MODULE_3__.initHeaderAccordion)();
    (0,_modules_modal_init_modals__WEBPACK_IMPORTED_MODULE_9__.initModals)();
    ...
    (0,_modules_sliders_init_certificates_slider__WEBPACK_IMPORTED_MODULE_4__.initCertificatesSlider)();
    (0,_modules_sliders_init_equipment_slider__WEBPACK_IMPORTED_MODULE_7__.initEquipmentSlider)();
    (0,_modules_sliders_init_completed_projects_slider__WEBPACK_IMPORTED_MODULE_8__.initCompletedProjectsSlider)();
    (0,_modules_phone_mask__WEBPACK_IMPORTED_MODULE_5__.initPhoneMask)();
    (0,_modules_init_phone_validation__WEBPACK_IMPORTED_MODULE_6__.initPhoneValidation)();
    (0,_modules_init_gallery__WEBPACK_IMPORTED_MODULE_10__.initGallery)();
    (0,_modules_video_loader_init_video_loader__WEBPACK_IMPORTED_MODULE_11__.initVideoLoader)();
  });
});
}();
/******/ })()
